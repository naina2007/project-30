...
function setup() {
    ...
    circle1=new Circle(90,300,20)

        
	sling =new SlingShot (circle1.body,{x:90,y:300})

  //text("press space to get a second chance to play",900,200);
